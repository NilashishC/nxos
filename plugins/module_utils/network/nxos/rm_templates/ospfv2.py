    ...
    PARSERS = [
        {
            ...
            "setval": "vrf {{ vrf }}",
            "result": {"vrfs": {'{{ "vrf_" + vrf|d() }}': {"vrf": "{{ vrf }}"}}},
            "shared": True,
        },
        {
            "name": "process_id",
            ...
            "result": {"process_id": "{{ process_id|int }}",},
            "shared": True,
        },
        {
        ...
        },
        {
            ...
            "setval": "flush-routes",
            "result": {"flush_routes": "{{ not not flush_routes }}"},
        },
        {
            ...
            "result": {
                "vrfs": {
                    '{{ "vrf_" + vrf|d() }}': {
                        "graceful_restart": {"set": "{{ not graceful_restart }}"}
                    }
                }
            },
        },
                ...
                "vrfs": {
                    '{{ "vrf_" + vrf|d() }}': {
                        "log_adjacency_changes": {
                            "detail": "{{ True if detail is defined else False }}",
                        }
                    }
                }
            },
        ...
        },
        {
            ...
            "result": {
                "mpls": {"traffic_eng": {"areas": [{"area_id": "{{ area_id }}",}]}}
            },
        },
        {
        ...
        },
        {
            ...
            "result": {
                "vrfs": {'{{ "vrf_" + vrf|d() }}': {"router_id": "{{ router_id }}"}}
            },
        },
        {
            "name": "shutdown",
            ...
            "result": {
                "vrfs": {
                    '{{ "vrf_" + vrf|d() }}': {"shutdown": "{{ not not shutdown }}"}
                }
            },
        },
        {
        ...
        },
        {
            ...
            "result": {
                "vrfs": {
                    '{{ "vrf_" + vrf|d() }}': {"default_metric": "{{ default_metric }}"}
                }
            },
        },
        {
        ...
        },
        {
            ...
            "result": {
                "vrfs": {
                    '{{ "vrf_" + vrf|d() }}': {
                        "timers": {"lsa_arrival": "{{ lsa_arrival_val }}"}
                    }
                }
            },
        },
        {
            ...
            "result": {
                "vrfs": {
                    '{{ "vrf_" + vrf|d() }}': {
                        "timers": {"lsa_group_pacing": "{{ lsa_group_pacing }}"}
                    }
                }
            },
        },
                    ...
                    '{{ "vrf_" + vrf|d() }}': {
                        "areas": {
                            "{{ area_id }}": {
                                "area_id": "{{ area_id }}",
                                "nssa": {
                                    "set": "{{ True if nssa is defined and no_summary is undefined and no_redistribution is undefined and default_information_originate is undefined }}",
